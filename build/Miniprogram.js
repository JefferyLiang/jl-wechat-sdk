...
class WechatMiniprogramSdk extends base_1.WechatBase {
    constructor(app_id, app_secret, option = {}) {
        ...
        if (this.DEBUG) {
            this.LOGGER(`[Wechat Miniprogram SDK] init with id: ${this.APP_ID}, secret: ${this.APP_SECRET} now`);
        }
    }
    getOpenIdAndSessionKey(code) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.DEBUG) {
                this.LOGGER("[ WECHAT MINIPROGRAM ] get open id and session key by code", code);
            }
